...
# ravel, reshape 는 종속되고, flatten은 독립되어 완전한 복사가 이루어지는 함수이다.

# b를 0,1 2,3 으로 이루어진 행렬로 정해준다.
>>> b = b.array([[0,1],
               [2,3]])
...
[[-1  1]
 [ 2  3]] 
[-1  1  2  3] # ravel: 복사 X -> 원본과 영향 O
[-1  1  2  3] # reshape: 복사 X -> 원본과 영향 O 
[0 1 2 3]     # flatten: 복사 O -> 원본과 영향 X
